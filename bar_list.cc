...
void BarList::addBar(SDL_Renderer& renderer,
...
std::chrono::time_point<std::chrono::high_resolution_clock> BarList::setEpoch(std::chrono::time_point<std::chrono::high_resolution_clock> epoch) {
    for (auto& b: bars) {
