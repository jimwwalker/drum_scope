...
public:
    ...
    void beat(int midiId, std::chrono::time_point<std::chrono::high_resolution_clock> time);
...
private:
    ...
    std::queue<std::pair<int, std::chrono::time_point<std::chrono::high_resolution_clock>>> beatQueue;
